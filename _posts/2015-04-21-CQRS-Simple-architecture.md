...
![Diagram of classic N-Layer architecture.](/assets/posts/CQRS_Simple_architecture/1_layered.png)
...
![Separated Commands and Queries with shared domain model](/assets/posts/CQRS_Simple_architecture/2_CQS_1.png)
...
![Separated READ and WRITE models](/assets/posts/CQRS_Simple_architecture/3_CQS_WRITE_READ.png)
...
![Queries can retrieve data directly from database](/assets/posts/CQRS_Simple_architecture/4_CQS_NoREAD.png)
...
![CQRS – READ model is updated by events](/assets/posts/CQRS_Simple_architecture/5_CQRS.png)
...
![CQRS with Event Sourcing](/assets/posts/CQRS_Simple_architecture/6_CQRS_ES.png)
